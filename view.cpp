...
void View::accountInteraction(Account &account) {
    string name;
...
void View::menuInteraction(Account &account) {
    while (true) {
        int choice;
        back:
...
void View::printAccountData(Account &account) {
    cout << "┌──────────────────┬───────────┬──────────────────┬─────────────┐" << endl;
...
void View::printCurrentAttemptTable(string shuffledWord, int attempts, string hint, int credits) {
    cout << "┌──────────────────────────────────────┬──────────────────────────────────────────────────────────────┬────────────────────┬───────────────────────┐" << endl;
...
void View::printSpaces(int n) {
    for (int i = 0; i < n; i++) {
        cout << ' ';
    }
}

int View::countUTF8Characters(const string &str) {
    int count = 0;
...
int View::countIntCharacters(int a) {
    int count = 0;
    if (a == 0) {
        return 1;
    }
